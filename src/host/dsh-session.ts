...
export interface LaunchTarget { port: number; token: string }
 ...
 */
export function parseLaunchTarget(logContent: string): LaunchTarget | undefined {
 ...
 */
export async function mintDshSessionCookie(
